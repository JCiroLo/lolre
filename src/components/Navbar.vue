  ...
  <nav class="navbar font-lol" :class="{ hide: getHideNavbar }">
    <div class="nav-content">
      ...
      <div class="routes">
        ...
        <router-link class="font-lol" to="/about">
          {{ translator().navbar.about }}
        </router-link>
      </div>
      <div class="settings">
        <div class="btn font-lol nav-icon custom-dropdown" @click="get()">
          <svg
          ...
          <div class="custom-dropdown-list">
            <div
              ...
              v-for="(lan, idx) in languages"
              :key="idx"
              @click="changeLanguage(lan.code)"
              :class="{ active: lan.code === language }"
            >
              {{ lan.name }}
            </div>
          </div>
...
import { languages, Translator } from '@/utils/Translator'
...
export default defineComponent({
  ...
  computed: {
    ...mapState(['language']),
    ...mapGetters(['getLanguage', 'getHideNavbar'])
  },
  methods: {
    ...
    get () {
      console.log(this.getHideNavbar)
    }
  }
})
</script>
